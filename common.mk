...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.hardware.camera.ar.xml:system/etc/permissions/android.hardware.camera.ar.xml \
    ...
    frameworks/native/data/etc/android.hardware.sensor.assist.xml:system/etc/permissions/android.hardware.sensor.assist.xml \
    ...
    frameworks/native/data/etc/android.software.picture_in_picture.xml:system/etc/permissions/android.software.picture_in_picture.xml.xml \
...
#Wifi
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/prebuilt/etc/wifi/WCNSS_qcom_cfg.ini:/vendor/etc/wifi/WCNSS_qcom_cfg.ini
